...
spl_autoload_register(function ($_class) {
    ...
    //     if (file_exists(PATH_KERNEL.DS.'lib'.DS.'templaters'.DS.'smarty'.DS.$_class.'.class.php')) {
    //         require_once PATH_KERNEL.DS.'lib'.DS.'templaters'.DS.'smarty'.DS.$_class.'.class.php';
    //     }
    // }
